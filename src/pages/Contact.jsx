...
function Contact() {
  ...
  return (
    // <div className="max-w-6xl lg:max-h-[700px] mx-auto my-10 bg-white rounded-xl mb-32 overflow-hidden shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]">
    <div
      className={
        theme === "light"
          ? "max-w-6xl lg:max-h-[700px] mx-auto my-10 bg-white rounded-xl mb-32 overflow-hidden shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]"
          : "max-w-6xl lg:max-h-[700px] mx-auto my-10 bg-white rounded-xl mb-32 overflow-hidden shadow-[8.0px_8.0px_8.0px_rgba(255,255,255,0.3)]"
      }
    >
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2 p-8 flex flex-col justify-center">
          <h2 className="text-4xl italic  font-extrabold mb-6 text-center text-gray-800  ">
            Contact Us
          </h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="group">
              <label
                htmlFor="name"
                className="block text-sm font-medium text-gray-700 mb-1 transition-all duration-300 group-focus-within:text-violet-600"
              >
                Name
              </label>
              ...
              {errors.name && touched.name ? (
                <p className="text-red-500 font-semibold ml-4">{errors.name}</p>
              ) : null}
            </div>
            <div className="group">
              <label
